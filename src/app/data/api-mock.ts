...
export const mockNotifications: NotificationDTO[] = [
  {
    ...
    title: {
      ...
      de: 'Neue Konsultation',
      en: 'New consultation',
    },
    message: {
      fr: 'Une nouvelle consultation sur le Parc Central vient d\'ouvrir',
      de: 'Eine neue Konsultation zum Zentralpark wurde eröffnet',
      en: 'A new consultation on Central Park has opened',
    },
    actionUrl: '/consultations/amenagement-parc-central-2026',
    actionLabel: {
      fr: 'Participer',
      de: 'Teilnehmen',
      en: 'Participate',
  ...
  },
  {
    ...
    priority: 'normal',
    title: {
      fr: 'Pétition proche de l\'objectif',
      de: 'Petition nahe am Ziel',
      en: 'Petition close to goal',
    },
    message: {
      fr: 'La pétition "Cantines scolaires bio" a atteint 3000 signatures !',
      de: 'Die Petition "Bio-Schulkantinen" hat 3000 Unterschriften erreicht!',
      en: 'The petition "Organic school canteens" reached 3000 signatures!',
    },
    actionUrl: '/petitions/cantines-scolaires-bio-locales',
    actionLabel: {
      fr: 'Voir la pétition',
      de: 'Petition ansehen',
      en: 'View petition',
  ...
  },
  {
    ...
    priority: 'high',
    title: {
      fr: 'Nouveau vote en cours',
      de: 'Neue Abstimmung läuft',
      en: 'New vote in progress',
    },
    message: {
      fr: 'Le vote pour le Budget Participatif 2026 est ouvert jusqu\'au 20 février',
      de: 'Die Abstimmung über den Bürgerbeteiligungshaushalt 2026 ist bis zum 20. Februar geöffnet',
      en: 'Voting for the 2026 Participatory Budget is open until February 20',
    },
    actionUrl: '/votes/budget-participatif-2026',
    actionLabel: {
      fr: 'Voter maintenant',
      de: 'Jetzt abstimmen',
      en: 'Vote now',
